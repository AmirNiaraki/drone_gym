...
"""
		...
		self.MAX_SPEED = 2 #maximum allowed drone speed
		### Max Speed was Originaly 5

		self.PADDING = 100
		self.FPS = 30
		self.OVERLAP = 0.5
		self.DEFAULT_WIND = (0.0,0.0) #the default wind is blowing towards positive x (west to east) 
		### DEFAULT_WIND=(3.5,0.0)
		...
		self.MAX_STEPS = 100000 #Max number of steps the drone is alowed to take during a simmulation run
cfg = Configs()
