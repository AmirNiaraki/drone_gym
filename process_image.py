...
def write(full_size, filename, factor):
    ...
    #TODO: This had problems with the images generated by world_generator.py so I removed it
    # I need to verify this won't break other types of images before removing entirely
    ...
    # TODO: I had to save the list of points because they do not save in the above line
    np.save(filename + "_points", all_points)
...
def process(image_path, factor):
    ...
    write(full_size, image_path, factor)
